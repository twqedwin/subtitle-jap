...
class SubtitleGeneratorApp(ctk.CTk):
    ...
    def _process_video(self) -> None:
        ...
        """
        try:
            # Step 1: Transcribe directly from video
            # Note: faster-whisper handles audio extraction internally,
            # saving time and disk space by avoiding intermediate WAV files.
            self._update_progress(0.1, "Loading model and analyzing audio...")
