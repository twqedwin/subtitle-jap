...
class SubtitleGeneratorApp(ctk.CTk):
    ...
    def _process_video(self) -> None:
        ...
        """
        try:
            # Step 1: Transcribe (DIRECTLY from video file)
            # faster-whisper handles audio extraction internally via ffmpeg/av
            self._update_progress(0.1, "Loading model and starting transcription...")
