...
class SubtitleGeneratorApp(ctk.CTk):
    ...
    def _process_video(self) -> None:
        ...
        """
        try:
            # Step 1: Transcribe (faster-whisper handles video files directly via ffmpeg)
            self._update_progress(0.0, "Loading model and starting transcription...")
            # ⚡ Bolt optimization: Passing video file directly to faster-whisper
            # skipping temporary file extraction
