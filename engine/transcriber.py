...
class JapaneseTranscriber:
    ...
    def transcribe(self, media_path: str) -> List[Dict]:
        ...
        try:
            ...
            # ⚡ Bolt optimization: Use faster-whisper's internal FFmpeg to process files directly
            # skipping explicit audio extraction and avoiding wave module limitations
